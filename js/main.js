...
if (document.querySelector('.map')) {
  let center = [56.33412336499504, 44.09855906610107];
  function init() {
    let map = new ymaps.Map('map', {
      center: center,
      zoom: 16
    });
    let placemark = new ymaps.Placemark([56.33461206837117, 44.103408499999986], {}, {
      iconLayout: 'default#image',
      iconImageHref: './img/marker.svg',
      iconImageSize: [268, 164],
      iconImageOffset: [-25, -164]
    });
...
const button = document.querySelector('.technological__block-btn--end');
document.body.addEventListener("click", () => {
  if (event.target.classList.contains("technological__block-btn")) {
    const content = event.target.previousElementSibling.querySelector(".content");
...
document.body.addEventListener("click", () => {
  if (event.target.classList.contains("technological__block-btn--end")) {
    const content = event.target.previousElementSibling.querySelector(".content-1");
    if (content.classList.contains("is-hidden")) {
      ;
...
// function tab(but_tab, hidden_block_tab, text_block, before_text, after_text) {
//   but_tab.addEventListener("click", function () {
//     let elements = Array.from(hidden_block_tab);
//     elements.forEach((el) => {
...
// const download_more = document.querySelector('#i-btn');
// // const download_more1 = document.querySelector('#s-btn');

// const hidden_list = document.querySelectorAll('#innovate-btn .tab_content');
// // const hidden_list1 = document.querySelectorAll('#standalone-btn .tab_content');

// const more_text = document.querySelector('#innovate-btn .text_more');
// // const more_text1 = document.querySelector('#standalone-btn .text_more');

// tab(download_more, hidden_list, more_text, "развернуть", "свернуть");
// // tab(download_more1, hidden_list1, more_text1, "развернуть", "свернуть");
...
const residentsSlider = document.querySelector('.resident-slider');
const newsSlider = document.querySelector('.new-slider');
const residentSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](residentsSlider, {
  slidesPerView: 2,
  spaceBetween: 30,
  autoHeight: false,
  navigation: {
...
const newSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](newsSlider, {
  slidesPerView: 3,
  spaceBetween: 30,
  autoHeight: false,
  navigation: {
